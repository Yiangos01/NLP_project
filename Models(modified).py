...
class RNNEncoder(EncoderBase):
    ...
    def concat_nupys_and_save(self):
        np.savetxt('inputs_final.txt', np.concatenate(self.nupmy_list))
    ...
    def forward(self, input, lengths=None, hidden=None):
        ...
        self.nupmy_list.append(outputs.data.data.numpy())

        # np.savetxt('encoder_outputs/word_output_batch_'+ str(self.counter) + '.txt', outputs.data.data.numpy())
        # self.counter +=1

        # print(outputs.data.data.numpy().shape)
